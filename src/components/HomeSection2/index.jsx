...
function HomeSection2() {
  ...
  return (
    <>
      <section ref={sectionRef} id="experience" className="flex flex-col gap-7">
        <div className={`${isDarkMode ? "text-white" : "text-black"} flex flex-col justify-end gap-1 items-center h-[20vh] ${isVisible ? "animate-fadeInLeft" : "opacity-0"}`}>
        ...
        <div className={`flex md:flex-row flex-col gap-3 md:gap-7 ${isVisible ? "animate-fadeInRight" : "opacity-0"}`}>
        ...
        {/* blog 2 */}
        <div className={`flex min-h-[46vh] items-center justify-end mt-5 ${isVisible ? "animate-fadeInLeft" : "opacity-0"}`}>
